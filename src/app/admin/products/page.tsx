                    ...
                    <td style={{ padding: '16px 20px' }}>
                      <button
                        ...
                        style={{
                          ...
                          background: product.is_published ? '#DCFCE7' : '#F3F4F6',
                          color: product.is_published ? '#166534' : '#6B7280',
                    ...
                    <td style={{ padding: '16px 20px' }}>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <Link
                          ...
                          style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '6px 12px', borderRadius: '6px', fontSize: '13px', fontWeight: 500, background: '#F2F2F2', color: '#0A0A0A', textDecoration: 'none', transition: 'background 0.12s' }}
                        >
                        ...
                        <button
                          ...
                          disabled={isDeleting}
                          style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '6px 12px', borderRadius: '6px', fontSize: '13px', fontWeight: 500, background: '#FEF2F2', color: '#EF4444', border: 'none', cursor: 'pointer', fontFamily: 'inherit', transition: 'background 0.12s', opacity: isDeleting ? 0.5 : 1 }}
                        >
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
